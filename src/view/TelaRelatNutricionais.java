 ...
 * @author vinicius
 */
public class TelaRelatNutricionais extends javax.swing.JFrame {

    public TelaRelatNutricionais() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabelImagemBannerCadastros.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/icon_relat_nutricionais_converted.png"))); // NOI18N
        jLabelImagemBannerCadastros.setText("Relatórios Nutricionais");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaRelatNutricionais.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
