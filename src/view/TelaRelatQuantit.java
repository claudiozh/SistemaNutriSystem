...
public class TelaRelatQuantit extends javax.swing.JFrame {

    public TelaRelatQuantit() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabelImagemBannerCadastros.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/icon_relat_quant.png"))); // NOI18N
        jLabelImagemBannerCadastros.setText("Relatórios Quantitativos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaRelatQuantit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
